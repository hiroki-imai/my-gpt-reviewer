...
export const COMMENT_TAG =
  "<!-- This is an auto-generated comment by OSS MyAiReviewer -->";

export const COMMENT_REPLY_TAG =
  "<!-- This is an auto-generated reply by OSS MyAiReviewer -->";

export const SUMMARIZE_TAG =
  "<!-- This is an auto-generated comment: summarize by OSS MyAiReviewer -->";

export const IN_PROGRESS_START_TAG =
  "<!-- This is an auto-generated comment: summarize review in progress by OSS MyAiReviewer -->";

export const IN_PROGRESS_END_TAG =
  "<!-- end of auto-generated comment: summarize review in progress by OSS MyAiReviewer -->";

export const DESCRIPTION_START_TAG =
  "<!-- This is an auto-generated comment: release notes by OSS MyAiReviewer -->";
export const DESCRIPTION_END_TAG =
  "<!-- end of auto-generated comment: release notes by OSS MyAiReviewer -->";
